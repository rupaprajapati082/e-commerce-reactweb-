...
const Wishlist = () => {
 ...
 <Link to="/products" className="inline-block px-10 py-4 bg-[#FF4C3B] text-white text-[11px] font-bold capitalize rounded-full hover:bg-[#7ab33f] transition-all shadow-md shadow-[#FF4C3B]/20">
 Browse Products
 </Link>
 </div>
 ) : (
 ...
 <p className="text-[10px] text-[#FF4C3B] font-bold capitalize ">{product.brand || 'Ecolife'}</p>
 <h3 className="font-bold text-xs text-[#222] truncate hover:text-[#FF4C3B] transition-colors">
 ...
 className="text-[9px] font-bold capitalize text-[#FF4C3B] hover:text-[#222] transition-colors"
 >
 View Options
 </button>
 </div>
